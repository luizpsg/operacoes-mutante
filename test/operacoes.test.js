...
describe('Suíte de Testes Reforçada para 50 Operações Aritméticas', () => {
  ...
  test('4. deve dividir e lançar erro específico para divisão por zero', () => {
  ...
  test('6b. deve calcular a raiz quadrada de zero sem erro', () => { expect(raizQuadrada(0)).toBe(0); });
  test('6c. deve lançar erro específico para raiz quadrada de negativo', () => {
  ...
  test('8b. deve retornar 1 para fatorial(0)', () => { expect(fatorial(0)).toBe(1); });
  test('8c. deve retornar 1 para fatorial(1)', () => { expect(fatorial(1)).toBe(1); });
  test('8d. deve lançar erro específico para fatorial de negativo', () => {
  ...
  test('10b. deve retornar 0 para soma de array vazio', () => { expect(somaArray([])).toBe(0); });

  // === Testes para o Bloco 2 (11-20) ===
  test('11. deve encontrar o valor máximo em um array', () => { expect(maximoArray([1, 50, 10])).toBe(50); });
  test('11b. deve lançar erro específico para maximoArray de array vazio', () => {
  ...
  test('12b. deve lançar erro específico para minimoArray de array vazio', () => {
  ...
  test('16b. deve retornar false para um número par', () => { expect(isImpar(2)).toBe(false); });
  ...
  test('33b. deve retornar false para isPrimo(1)', () => { expect(isPrimo(1)).toBe(false); });
  test('33c. deve retornar false para isPrimo(0)', () => { expect(isPrimo(0)).toBe(false); });
  test('33d. deve retornar false para número não primo (4)', () => { expect(isPrimo(4)).toBe(false); });
  test('33e. deve retornar true para o menor primo (2)', () => { expect(isPrimo(2)).toBe(true); });
  ...
  test('36b. deve retornar min quando valor abaixo do mínimo', () => { expect(clamp(-5, 0, 10)).toBe(0); });
  test('36c. deve retornar max quando valor acima do máximo', () => { expect(clamp(15, 0, 10)).toBe(10); });
  test('36d. deve distinguir -0 quando valor === min (mata mutante <=)', () => {
    expect(Object.is(clamp(-0, 0, 10), -0)).toBe(true);
  });
  test('36e. deve distinguir -0 quando valor === max (mata mutante >=)', () => {
  ...
  test('38b. deve converter 100 Celsius para 212 Fahrenheit', () => { expect(celsiusParaFahrenheit(100)).toBe(212); });
  test('39. deve converter Fahrenheit para Celsius', () => { expect(fahrenheitParaCelsius(32)).toBe(0); });
  test('39b. deve converter 212 Fahrenheit para 100 Celsius', () => { expect(fahrenheitParaCelsius(212)).toBeCloseTo(100); });
  test('40. deve calcular o inverso de um número', () => { expect(inverso(4)).toBe(0.25); });
  test('40b. deve lançar erro específico ao inverter zero', () => {
  ...
  test('44b. deve retornar false quando os números são iguais (isMaiorQue)', () => {
    expect(isMaiorQue(5, 5)).toBe(false);
  });
  test('44c. deve retornar false quando a < b (isMaiorQue)', () => {
    expect(isMaiorQue(3, 5)).toBe(false);
  });
  test('45. deve verificar se um número é menor que outro', () => { expect(isMenorQue(5, 10)).toBe(true); });
  test('45b. deve retornar false quando os números são iguais (isMenorQue)', () => {
    expect(isMenorQue(5, 5)).toBe(false);
  });
  test('45c. deve retornar false quando a > b (isMenorQue)', () => {
    expect(isMenorQue(10, 5)).toBe(false);
  });
  test('46. deve verificar se dois números são iguais', () => { expect(isEqual(7, 7)).toBe(true); });
  test('46b. deve retornar false quando os números são diferentes (isEqual)', () => {
  ...
  test('47b. deve calcular a mediana de um array ímpar desordenado', () => {
    expect(medianaArray([5, 1, 3, 2, 4])).toBe(3);
  });
  test('47c. deve calcular a mediana de um array par', () => {
    expect(medianaArray([1, 2, 3, 4])).toBe(2.5);
  });
  test('47d. deve calcular a mediana de um array par desordenado', () => {
    expect(medianaArray([4, 1, 3, 2])).toBe(2.5);
  });
  test('47e. deve lançar erro específico para mediana de array vazio', () => {
