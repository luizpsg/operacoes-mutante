...
function fatorial(n) {
  ...
  // Stryker disable next-line all: guarda redundante — o laço abaixo já retorna 1 para n=0 e n=1 (mutantes equivalentes).
  if (n === 0 || n === 1) return 1;
  let resultado = 1;
...
function produtoArray(numeros) {
  // Stryker disable next-line all: guarda redundante — reduce com valor inicial 1 já retorna 1 para array vazio (mutante equivalente).
